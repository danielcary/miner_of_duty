...
namespace Miner_Of_Duty.Game.ParticleSystem
{
    public abstract class ParticleSystem
    {
        ...
        protected class ParticleSettings
        {
        ...
        protected void LoadContent()
        {
            ...
            if (MinerOfDuty.mainMenu == null)
            {
                System.Diagnostics.Debug.WriteLine("We got a null mainmenu, this is okay as long is the game is loading");
                return;
            }

            // Create a dynamic vertex buffer.
            vertexBuffer = new DynamicVertexBuffer(MinerOfDuty.mainMenu.minerOfDuty.GraphicsDevice, ParticleVertex.VertexDeclaration,
            ...
            indexBuffer = new IndexBuffer(MinerOfDuty.mainMenu.minerOfDuty.GraphicsDevice, typeof(ushort), indices.Length, BufferUsage.WriteOnly);
        ...
        public void Draw()
        {
            GraphicsDevice device = MinerOfDuty.mainMenu.minerOfDuty.GraphicsDevice;
        ...
        {
            effectViewParameter.SetValue(cam.ViewMatrix);
            effectProjectionParameter.SetValue(cam.ProjMatrix);
        }
